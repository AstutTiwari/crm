                              ...
                              <div class="settings-form">
                                  <div class="row no-margin">
                                      ...
                                      <div class="form-group banner-change mb-3 col-md-6">
                                          ...
                                          <input type="hidden" class="form-control required" name="image_check"  id="image_check">
                                      ...
                                      <div class="form-group mt-4 col-md-6">
                                        <ul class="single-upload d-none" id="upload_image">
                                              <li class="image-single">
                                                  <img src="" id="uploaded_image" name="image_ids" alt="image" width="121px" hight="121px" class="img-fluid img-thumbnail">

    ...
    <div class="row">
        <div class="col-12 leads-section teant-top-btn">
            <div class="top-bar-section">
                <a href="{{route('emploies.create')}}"  class="btn btn-cancel mr-2" >Add Employee <i class="mdi mdi-information-outline"></i></a>
            </div>
            <div class="card leads-table-card">
                <div class="card-body leads-table-body">
                    <div class="section-title-top">
                        <div class="title-left">
                           <h1 class="header-title">Employee</h1>
                        </div>
                        
                    </div>
                    <table id="employeTable" class="table dt-responsive nowrap w-100">
                        <thead>
                            <tr>
                                <th>Full Name</th>
                                <th>Company</th>
...
<script>
    ...
    table_instance = $('#employeTable').DataTable({
        "lengthChange": false,
        "language": {
            "paginate": {
    ...
    function employeDelete(data=null,id=null)
    {
    $.confirm({
        title: 'Confirm!',
        content: 'Do you want to delete the selected Employe ?',
        buttons: {
            confirm: {
                text: 'Yes',
